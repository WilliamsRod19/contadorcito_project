...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO tbl_Comprobantes_Compra 
            (empresa_id, tipo_comprobante_id, numero, fecha, monto, proveedor, archivo_pdf, archivo_json, created_at) 
            VALUES 
            (:empresa_id, :tipo_comprobante, :numero_comprobante, :fecha_comprobante, :monto, :proveedor, :archivo_pdf, :archivo_json, NOW())";
