        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container mt-4">
                    <h2>¿Estás seguro de eliminar este comprobante?</h2>
                    ...
                    <form action="../../controllers/purchases/deletePurchaseController.php" method="GET">
                        <input type="hidden" name="id" value="<?= htmlspecialchars($comprobante['id']) ?>">
                        <input type="hidden" name="action" value="delete">
                        <div class="mb-3">
                            <button type="submit" class="btn btn-danger">Eliminar</button>
                            <a href="../../views/purchases/indexPurchases.php" class="btn btn-secondary">Cancelar</a>
                        </div>
                    </form>
                </div>
