...
<head>
    ...
    <title>Registrar Comprobante de Venta</title>
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                <a class="nav-link collapsed" href="../companies/indexCompanies.php">Empresas</a>
                                <?php if ($_SESSION["user"] == "Administrador") { ?>
                                    <a class="nav-link collapsed" href="../users/indexUsers.php">Usuarios</a>
                                <?php }; ?>
                                <a class="nav-link collapsed" href="../sales/indexSales.php">Comprobantes de Ventas</a>
                                <a class="nav-link collapsed" href="../purchases/indexPurchases.php">Comprobantes de Compras</a>
                            </nav>
                        </div>
                    </div>
                </div>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container mt-5">
                    <h1>Registrar Comprobante de Venta</h1>
                    <form method="POST" action="../../controllers/sales/addSalesController.php" enctype="multipart/form-data" onsubmit="return validateFiles()">
                        <div class="mb-3">
